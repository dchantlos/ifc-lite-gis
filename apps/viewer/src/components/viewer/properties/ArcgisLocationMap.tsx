  ...
  useEffect(() => {
    ...
    const initScene = () => {
      ...
      view = new SceneView({
        ...
        // environment, which makes the minimap render very dark. Force
        // a daylight noon-UTC sun and disable shadows for a bright,
        // flat preview suitable for the small map.
        environment: {
          lighting: {
            type: 'sun',
